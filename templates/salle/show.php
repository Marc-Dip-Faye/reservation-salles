...
<title>Détail salle — UniSpace</title>
<link rel="preconnect" href="https://fonts.googleapis.com">
<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
<link href="https://fonts.googleapis.com/css2?family=Fraunces:opsz,wght@9..144,500;9..144,600;9..144,700&family=Inter:wght@400;500;600;700&display=swap" rel="stylesheet">
<style>
:root{--bg:#f3ede3;--surface:#fffdf9;--surface-2:#faf6ee;--ink:#221a13;--ink-2:#57493c;--muted:#93867a;--line:#e2d7c5;--line-2:#efe8db;--accent:#a34e26;--accent-2:#8a3f1d;--accent-soft:#f5e2d4;--accent-ring:rgba(163,78,38,.25);--green:#2e7b4f;--green-soft:#e2f1e6;--shadow-sm:0 1px 2px rgba(34,26,19,.05),0 2px 8px rgba(34,26,19,.05);--shadow-md:0 2px 4px rgba(34,26,19,.06),0 16px 34px -16px rgba(34,26,19,.22);--font-ui:'Inter',system-ui,sans-serif;--font-display:'Fraunces',Georgia,serif}
...
<main class="main">
  <div class="container">
    ...
    <div class="page-head">
      <div>
        <p class="page-head__eyebrow">Fiche salle</p>
        <h1>Amphi Turing</h1>
        <p class="page-head__sub">Référence #1</p>
      </div>
      <div class="page-head__actions">
        <a class="btn btn--primary" href="/salles/1/edit">Modifier</a>
    ...
    <section class="panel">
      <div class="panel__head">
        <div>
          ...
          <p>Caractéristiques principales de la salle</p>
        </div>
        <span class="badge badge--ok">Active</span>
      </div>
      <div class="detail">
        <div class="detail__item">
          <p class="detail__label">Nom</p>
          <p class="detail__value">Amphi Turing</p>
        </div>
        <div class="detail__item">
          <p class="detail__label">Bâtiment</p>
          <p class="detail__value">Bâtiment A</p>
        </div>
        <div class="detail__item">
          <p class="detail__label">Capacité</p>
          <p class="detail__value">220 places</p>
        </div>
        <div class="detail__item">
          <p class="detail__label">Type</p>
          <p class="detail__value"><span class="tag">Amphithéâtre</span></p>
        </div>
        <div class="detail__item">
          <p class="detail__label">Statut</p>
          <p class="detail__value"><span class="badge badge--ok">Active</span></p>
        </div>
      </div>
    </section>
