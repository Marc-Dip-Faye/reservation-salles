...
<title>Méthode non autorisée — UniSpace</title>
...
<main class="main">
  <div class="container">
    <section class="error-hero">
      <p class="error-hero__code">405</p>
      <h1>Méthode non autorisée</h1>
      <p>La méthode utilisée pour accéder à cette ressource n'est pas autorisée. Vérifiez votre action ou retournez à l'accueil.</p>
